		...
		if(gameData.length() > 0 &&  gameData.charAt(0) == 'L') {	// If our switch is to the left...
    		switch (robotLocation) {
    			...
    			case 1:	// Left Switch ...and we are to the left...
    				if (robotTimer.get() > 1.3 && robotTimer.get() < 4.7) {	// ...timer 3.4 seconds...
    					driveTrain.arcadeDrive(0.7, 0.0);	// ... FORWARD 0.7 speed
    				} else if (robotTimer.get() > 4.7 && robotTimer.get() < 6.4) {	// ...timer 1.7 seconds...
    					driveTrain.arcadeDrive(0.0, 0.6);	// ... ROTATE RIGHT 0.6 speed
    				} else if (robotTimer.get() > 6.4 && robotTimer.get() < 7.7) { // ... timer 1.3 seconds...
    					driveTrain.arcadeDrive(0.6, 0.0);	// ... FORWARD 0.7 speed
    				} else if (robotTimer.get() > 7.7 && robotTimer.get() < 7.8 ) {	// ... and the time is between 5.3 and 5.4 seconds...
    			...
    			case 3:  // Left Switch ... and we are to the right...
    				if (robotTimer.get() > 1.3 && robotTimer.get() < 5.7) {	// ...timer 4.4 second(s)...
    					driveTrain.arcadeDrive(0.7, 0.0);	// ...drive straight at 0.7 speed
    				} else if (robotTimer.get() > 5.7 && robotTimer.get() < 7.6) {	// ...timer 1.9 seconds...
    		...
    		switch (robotLocation) {
				...
				case 3:	// Right Switch  ...and we are to the right...
					if (robotTimer.get() > 1.3 && robotTimer.get() < 4.7) {	// ...timer 3.4 seconds...
    					...
    					driveTrain.arcadeDrive(0.0, -0.6);	// ... ROTATE LEFT (negative) 0.6 speed
    				} else if (robotTimer.get() > 6.4 && robotTimer.get() < 7.7) { // ... timer 1.3 seconds...
    					driveTrain.arcadeDrive(0.6, 0.0);	// ... FORWARD 0.7 speed
    				} else if (robotTimer.get() > 7.7 && robotTimer.get() < 7.8 ) {	// ... and the time is between 5.3 and 5.4 seconds...
    						gripperSolenoid.set(DoubleSolenoid.Value.kForward);	// ...drop the cube
